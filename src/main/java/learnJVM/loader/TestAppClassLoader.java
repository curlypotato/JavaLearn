...
public class TestAppClassLoader {
    public static void main(String[] args) throws Exception{
        ...
        /*Class<?> clazz1 = Class.forName("learnJVM.loader.Student", true, loader);
        Class<?> clazz2 = Class.forName("learnJVM.loader.Student", true, loader);
        ...
        Class.forName("learnJVM.loader.Student", true, loader);
    }
